...
export class UserService {
    ...
    async findById(id: string): Promise<AppResponse<UserResponseDto>> {
        ...
        if (cachedData) {
            ...
            return new AppResponse(SuccessConstant.DetailFetch, cachedData, { module: MapToModuleName(ModuleNames.USER) });
        }
    ...
    async findList(searchRequest: ListUserRequestDto): Promise<AppResponse<CommonSearchResponseDto<UserResponseDto>>> {
        ...
        if (cachedData) {
            ...
            return new AppResponse(SuccessConstant.ListFetch, cachedData, { module: MapToModuleName(ModuleNames.USER) });
        }
