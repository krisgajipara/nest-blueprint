...
export class SendMailerUtility {
    ...
    async sendStudentOnboardingEmail(studentData) {
        const context = {
            recipientName: `${studentData.firstName} ${studentData.lastName}`,
            studentName: `${studentData.firstName} ${studentData.lastName}`,
            batchName: studentData.batchName || "To be assigned",
            coachName: studentData.coachName || "To be assigned",
