...
import { MapToModuleName, SubdomainUtility } from "@core-utilities";
import {
    Body,
    Controller,
    Get,
...
export class TenantController {
  constructor(
    ...
    private readonly subdomainUtility: SubdomainUtility,
  ) {}
  ...
  async getBySubdomain(
    ...
    const subdomain = this.subdomainUtility.extractSubdomain(originOrHost);
  ...
  @ApiOperation({
    ...
    description: "Admin only: Get full tenant details.",
  })
  @ApiResponseStatus(
    "Get tenant by ID",
  ...
  @RequirePermissions({
    module: MODULE_CONSTANTS.TENANT,
    permission: PERMISSION_CONSTANTS.WRITE,
  })
  @ApiOperation({
    summary: "Create a new tenant",
    description: "Admin only: Create a new tenant configuration.",
  })
  @ApiResponseStatus(
    "Create a new tenant",
  ...
  @RequirePermissions({
    module: MODULE_CONSTANTS.TENANT,
    permission: PERMISSION_CONSTANTS.EDIT,
  })
  @ApiParam({ name: "id", description: "Tenant ID" })
  @ApiOperation({
  ...
  @ApiOperation({
    ...
    description:
      "Admin only: Deactivate an existing tenant by setting its status to INACTIVE.",
  })
  @ApiResponseStatus(
    "Deactivate tenant",
    [HttpStatus.OK, HttpStatus.BAD_REQUEST, HttpStatus.NOT_FOUND],
  ...
  @ApiOperation({
    ...
    description:
      "Admin only: Activate an existing tenant by setting its status to ACTIVE.",
  })
  @ApiResponseStatus(
    "Activate tenant",
    [HttpStatus.OK, HttpStatus.BAD_REQUEST, HttpStatus.NOT_FOUND],
